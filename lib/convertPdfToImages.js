...
// Quick page count by scanning raw bytes for /Type /Page entries.
// Works for uncompressed xref tables; returns null for compressed xref streams
// (convertPdfToImages will set the real count later via fire-and-forget).
export function getPdfPageCountFromBuffer(buffer) {
